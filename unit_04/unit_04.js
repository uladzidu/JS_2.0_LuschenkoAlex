...
function f5() {
    ...
    input.checked ? out.textContent = input.value : out.textContent = false
...
function f7() {
    ...
    let out2 = document.querySelector('div.out-72')

    out.textContent = input.value

    input.value.length >= 6 ? out2.textContent = 1 : out2.textContent = 0
...
function f16() {
    ...
    let selectOption = document.querySelector('.s-16')
    let out = document.querySelector('.out-16')

    out.textContent = selectOption.value
...
function f17() {
    ...
    let selectOption = document.querySelector('.s-17')
...
function f18() {
    ...
    let selectOption = document.querySelector('.s-18')
...
function f19() {
    ...
    let div = document.querySelector('div.out-19')
