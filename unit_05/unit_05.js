...
function t11() {
    ...
    let outVariable = document.querySelector('.out-11')
    let out = ''

    for (let i = 0; i < divs11.length; i++) {
        out = out + divs11[i].innerHTML + '_'
    }
...
function t13() {
    ...
    let allInputs = document.querySelectorAll('input.i-13')
...
function t14() {
    ...
    let allInputs = document.querySelectorAll('input.i-14')
    let out = document.querySelector('.out-14')

    for (let i = 0; i < allInputs.length; i++) {

        allInputs[i].checked ? out.textContent = allInputs[i].value : ''
...
function t15() {
    ...
    let outVariable = document.querySelector('.out-15')
    let out = ''
