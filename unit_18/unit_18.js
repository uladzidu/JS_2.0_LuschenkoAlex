...
function t3() {
    ...
    a3.forEach(elem => {
        typeof elem === 'number' ? a3_res.push(elem) : ''
    })
...
function t9() {
    ...
    a9_res = a9.flat().join('-') // метод flat() создает новый массив, в который соединяются все вложенные массивы
...
function t10() {
    ...
    let array = Object.keys(a10).map(function (element){

        return `${element}=${a10[element]}`
