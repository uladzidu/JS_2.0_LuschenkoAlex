...
function f9() {
    ...
    let maxIndex = a9[0].length - 1

    for (let i = 0; i < a9.length; i++) {
        if (a9[i].length - 1 > maxIndex) {
            maxIndex = a9[i].length - 1
        }
    }
...
function f15() {
    ...
    let allSelectors = document.querySelectorAll('.out-15')
